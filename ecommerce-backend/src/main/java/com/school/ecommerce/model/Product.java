...
public class Product {
    ...
    public Product(String id, String name, String description, double price, String categoryId,
        ...
        this.categoryId = categoryId; this.images = images; this.availablePlatforms = availablePlatforms;
    ...
    public boolean isLocalSale() { return isLocalSale; }
    public void setLocalSale(boolean localSale) { isLocalSale = localSale; }
}
